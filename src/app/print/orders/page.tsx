...
export default async function PrintBulkOrders({
    ...
    return (
        <div className="bg-white text-black font-sans">
            ...
            <div className="print:hidden flex items-center gap-3 bg-gray-100 border-b px-6 py-3 sticky top-0 z-10">
            ...
            {orders.map((order, index) => (
                <div
                    key={order.id}
                    className="min-h-screen p-8 max-w-3xl mx-auto print:max-w-none print:p-6"
