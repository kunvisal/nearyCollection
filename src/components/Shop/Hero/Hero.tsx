...
const SOCIAL_LINKS = [
    ...
    },
    {
        ...
        url: "#",
        color: "#000000" // Black for generic text usually, but icon can be specific
    },
    {
        name: "Location",
        label: "Phnom Penh",
            ...
            <div className={styles.profileSection}>
                ...
                <div className={styles.contactSection}>
                    ...
                    <div className={styles.socialList}>
                        {SOCIAL_LINKS.filter(link => ["Facebook", "Instagram", "Location"].includes(link.name)).map((link) => (
                            <a
                                key={link.name}
                                href={link.url}
                                target="_blank"
                            ...
                            >
                                ...
                                <div className={styles.contactText}>
                                    ...
                                    <span className={styles.contactType}>{link.name}</span>
                                </div>
                            </a>
                        ))}
                    </div>
