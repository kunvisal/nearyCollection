  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute -right-2 mt-[17px] flex h-[480px] w-[350px] max-w-[calc(100vw-32px)] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] sm:right-0"
      >
