...
export const EcommerceMetrics: React.FC<EcommerceMetricsProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 md:gap-6">
      ...
      {/* Revenue Metric */}
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        <div className="flex items-center justify-center w-12 h-12 bg-blue-100 text-blue-700 rounded-xl dark:bg-blue-900/30 dark:text-blue-400">
      ...
      {/* Profit Metric */}
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        <div className="flex items-center justify-center w-12 h-12 bg-emerald-100 text-emerald-700 rounded-xl dark:bg-emerald-900/30 dark:text-emerald-400">
          <span className="font-bold text-xl">$</span>
        </div>
        <div className="flex items-end justify-between mt-5">
          <div>
            <span className="text-sm text-gray-500 dark:text-gray-400">Total Profit</span>
            <h4 className="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">${totalProfit.toFixed(2)}</h4>
          </div>
        </div>
      </div>
    </div>
